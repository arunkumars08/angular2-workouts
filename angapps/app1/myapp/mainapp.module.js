...
var MonthlyCalendar_1 = require('./MonthlyCalendar');
...
var MainAppModule = (function () {
    ...
    MainAppModule = __decorate([
        core_1.NgModule({
            ...
            declarations: [MonthlyCalendar_1.MonthCalendarComponent, yearcalendar_1.YearCalendarComponent],
            bootstrap: [yearcalendar_1.YearCalendarComponent]
        }), 
